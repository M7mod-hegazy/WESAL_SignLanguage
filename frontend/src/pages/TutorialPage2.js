        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              fontFamily: theme.typography.fonts.primary,
              cursor: 'pointer',
              boxShadow: '0 6px 20px rgba(0, 85, 147, 0.4)',
              transition: 'all 0.3s ease'
            }}
            onMouseEnter={(e) => {
              e.target.style.transform = 'translateY(-2px)';
              e.target.style.boxShadow = '0 8px 25px rgba(0, 85, 147, 0.5)';
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = 'translateY(0)';
              e.target.style.boxShadow = '0 6px 20px rgba(0, 85, 147, 0.4)';
            }}
          >
            التالي
          </button>
